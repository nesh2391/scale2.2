...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let checkIfTokenIsPresent: string = localStorage.getItem('token');
    if ( checkIfTokenIsPresent ) {
        // this case can be when page is refreshed
      this.profileService.updateProfile(checkIfTokenIsPresent);
    }
  }
